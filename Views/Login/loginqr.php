      ...
      <div class="login-box">
        ...
        <form class="login-form" name="formLogin" id="formLogin" action="">
          ...
          <div class="form-group">
            ...
            <input id="id_restaurant" name="id_restaurant" class="form-control" type="txt" placeholder="ID_RESTAURANT" autofocus>
          </div>
        ...
        <form id="formRecetPass" name="formRecetPass" class="forget-form" action="">
          ...
          <div class="form-group">
            ...
            <input id="id_restaurantReset" name="id_restaurantReset" class="form-control" type="email" placeholder="Email">
          </div>
          <div class="form-group btn-container">
